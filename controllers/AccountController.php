...
class AccountController {
	...
	public function actionIndex() {
		...
		if ($user['confirmation'] == "") {
			$this->actionSendConfirmationEmail($userId);
		}

		$confirmation = ($user['confirmation'] == "confirmed");

		$pageTitle = User::getUserName($userId);
	...
	public function actionSendConfirmationEmail($userId) {
		...
		User::sendEmail($userId, $subject, $body);
